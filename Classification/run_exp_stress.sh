...
# biosignals
python3 main.py --task stress --emo_dim valence --d_rnn 16 --rnn_n_layers 4 --lr 0.005 --rnn_bi --feature BPM --cache --result_csv  baseline_results/stress_signals.csv --n_seeds 20 --seed 101 --batch_size 256  --early_stopping_patience 15 --reduce_lr_patience 5
